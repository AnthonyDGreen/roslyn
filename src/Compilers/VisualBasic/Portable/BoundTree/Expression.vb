...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend Class BoundAggregateClause
        ...
        Protected Overrides ReadOnly Property Children As ImmutableArray(Of IOperation)
            Get
                Return ImmutableArray.Create(Of IOperation)(Me.CapturedGroupOpt, Me.UnderlyingExpression)
            End Get
        End Property
    ...
    Partial Friend NotInheritable Class BoundJsonObject
        Protected Overrides Function ExpressionKind() As OperationKind
            Return OperationKind.None
        End Function
    ...
    Partial Friend NotInheritable Class BoundJsonArray
        Protected Overrides Function ExpressionKind() As OperationKind
            Return OperationKind.None
        End Function
    ...
    Partial Friend NotInheritable Class BoundJsonNameValuePair
        Protected Overrides Function ExpressionKind() As OperationKind
            Return OperationKind.None
        End Function
    ...
    Partial Friend NotInheritable Class BoundJsonConstant
        Protected Overrides Function ExpressionKind() As OperationKind
            Return OperationKind.None
        End Function
