...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend NotInheritable Class CaseBlockBinder
        ...
        Private Function BuildLocals() As ImmutableArray(Of LocalSymbol)
            Dim caseStatement = _syntax.CaseStatement
            ...
            For Each clause In caseStatement.Cases
                If clause.Kind <> SyntaxKind.TypeCaseClause Then Continue For

                Dim typeClause = DirectCast(clause, TypeCaseClauseSyntax)
