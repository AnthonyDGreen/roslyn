...
Namespace Microsoft.CodeAnalysis.VisualBasic
    Partial Friend Class Binder
        ...
        Private Function BindXmlElement(
            ...
            If rootInfoOpt Is Nothing Then
                Dim result = TryBindXmlPatternElement(syntax, nameSyntax, attributes, content, rootInfoOpt, diagnostics)
                ...
                result = binder.BindXmlElement(syntax, nameSyntax, attributes, content, New XmlElementRootInfo(Me, syntax, importedNamespaces), diagnostics)
