    ...
    Friend Module SyntaxTreeExtensions
        ...
        Friend Function IsExpressionContext(
            ...
            If targetToken.IsChildToken(Of AddRemoveHandlerStatementSyntax)(Function(handlerStatement) handlerStatement.AddHandlerOrRemoveHandlerKeyword) OrElse
               ...
               targetToken.IsChildToken(Of JsonObjectExpressionSyntax)(Function(jsonObjectExpression) jsonObjectExpression.OpenBraceToken) OrElse
               targetToken.IsChildSeparatorToken(Of JsonObjectExpressionSyntax, ExpressionSyntax)(Function(jsonObjectExpression) jsonObjectExpression.Members) OrElse
               targetToken.IsChildToken(Of JsonArrayExpressionSyntax)(Function(jsonArrayExpression) jsonArrayExpression.OpenBracketToken) OrElse
               targetToken.IsChildSeparatorToken(Of JsonArrayExpressionSyntax, ExpressionSyntax)(Function(jsonArrayExpression) jsonArrayExpression.Elements) OrElse
               targetToken.IsChildToken(Of JsonNameValuePairExpressionSyntax)(Function(jsonNameValuePairExpression) jsonNameValuePairExpression.ColonToken) OrElse
